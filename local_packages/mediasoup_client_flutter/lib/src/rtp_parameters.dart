...
class RtpEncodingParameters extends RTCRtpEncoding {
  ...
  static RTCPriorityType? _parsePriority(String? p) {
    if (p == null) return null;
    switch (p) {
      case 'very-low': return RTCPriorityType.veryLow;
      case 'low': return RTCPriorityType.low;
      case 'medium': return RTCPriorityType.medium;
      case 'high': return RTCPriorityType.high;
      default: return null;
    }
  }
  ...
  static RtpEncodingParameters fromMap(Map data) {
    return RtpEncodingParameters(
      ...
      priority: _parsePriority(data['priority']) ?? RTCPriorityType.low,
      networkPriority: _parsePriority(data['networkPriority']),
