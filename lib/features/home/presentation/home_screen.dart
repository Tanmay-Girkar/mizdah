...
/// One row in the Recent Activity list. Mirrors the content layout of
/// `_RecentCard` on the Meetings tab — palette-rotated icon tile,
/// title + relative-time + duration — so the home preview reads
/// identically to the full list behind "View all".
class _RecentActivityRow extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final palette = md.MizdahTokens.rowColors[colorIndex % 5];
                  ...
                  Row(
                    children: [
                      Icon(Icons.schedule_rounded,
                          color: md.MizdahTokens.mutedOf(context), size: 12),
